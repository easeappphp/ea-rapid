...
if (interface_exists('\EaseAppPHP\EARapid\Foundation\Interfaces\BaseCliControllerInterface')) {
	
    class BaseCliController implements \EaseAppPHP\EARapid\Foundation\Interfaces\BaseCliControllerInterface
    {
		protected $container;
		protected $config;
